...
public abstract class FunctionalJavaCollectionDeserializer<T>
    ...
    protected FunctionalJavaCollectionDeserializer(CollectionLikeType type,
     ...
     * instances.
     */
    public abstract FunctionalJavaCollectionDeserializer<T> withResolved(
