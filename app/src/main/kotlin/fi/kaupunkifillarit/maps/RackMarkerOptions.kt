...
fun rackMarker(rack: Rack, res: Resources): MarkerOptions = MarkerOptions().apply {
    icon(BitmapDescriptorFactory.fromBitmap(RackMarkerBitmap.bitmap(rack.bikes < 2, "${rack.bikes}", res)))
    flat(true)
